...
switchNormalImage:function(a){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].switchNormalImage(a)},destroy:function(){}}).extend(Book);
