...
this.button=a;this.initPrintEvent()},getImageSizeForMM:function(a,b){return a/210>=b/297?{width:210,height:Math.floor(210*b/a)}:{width:Math.floor(297*a/b),height:297}},getImageSizeForInches:function(a,b){return a/7.18>=b/10.61?{width:7.18,height:Number.fixed(7.18*b/a,2)}:{width:Number.fixed(10.61*a/b,2),height:10.61}},getImageSizeForIE:function(a,b){return a/8>=b/11.3?{width:8,height:Number.fixed(8*b/a,2)}:{width:Number.fixed(11.3*a/b,2),height:11.3}},printPages:function(a){var b=this;if(a&&a.length){this.initLoadPrint();
var c=0;this.printArea.empty();this.printArray=[];var d=function(e,g,f,h){var k=$("<div style='position:relative;width:100%;height:100%;'></div>"),l=$(f);e&&-1<e.indexOf("none")&&!e.startsWith("data:image")&&g&&0>g.indexOf("none")&&(l=$(g));void 0===h&&(h=f);k.append(l);parseBool(bookConfig.PrintButtonVisible)&&""!=bookConfig.printWatermarkFile&&($watermark=$("<img src = '"+bookConfig.printWatermarkFile+"'/>"),$watermark.css({"z-index":"201",position:"absolute",maxWidth:"80px",maxHeight:"80px",top:"50%",
left:"50%",transform:"translate(-50%,-50%)"}),k.append($watermark),this.getImageSizeForInches($watermark[0].naturalWidth,$watermark[0].naturalHeight));$(l).parent().css({"text-align":"center",width:"100%",height:"100%"});l.css({"text-align":"center","max-width":"100%","max-height":"100%"});"stretch"===bookConfig.printBackgroundPosition?l.css({width:"100%",height:"100%"}):"fill"===bookConfig.printBackgroundPosition?l.css({width:"100%",height:"100%","object-fit":"cover"}):$(l).parent().css({display:"flex",
"justify-content":"center","align-items":"center"});this.printArray[h]=k;c++;if(c==a.length){for(e=1;e<this.printArray.length;e++)this.printArray[e]&&this.printArea.append(this.printArray[e]);this.printArea.printArea();this.hidePrintLoading()}};getPageDir(1,"normal").then(function(e){var g=BookInfo.getBook().pageWidth,f=BookInfo.getBook().pageHeight;!window.printLoadStack&&(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<e.indexOf("zip"))&&b.initPrintStack(a);if(bookConfig.normalSuffix&&
"zip"===bookConfig.normalSuffix||-1<e.indexOf("zip"))g*=2,f*=2;if(parseBool(bookConfig.PrintButtonVisible))if(""!=bookConfig.printWatermarkFile)$("<img src = '"+bookConfig.printWatermarkFile+"'/>").on("load",function(){for(var l=this,m={},n=0;n<a.length;m={$jscomp$loop$prop$page$1:m.$jscomp$loop$prop$page$1},n++)m.$jscomp$loop$prop$page$1=a[n],"object"!=typeof e&&e.match(/none/)?this.getPrintImgType(m.$jscomp$loop$prop$page$1).then(function(p){return function(q){pageResourceLoad(p.$jscomp$loop$prop$page$1,
q,d.bind(l),g,f)}}(m)):pageResourceLoad(m.$jscomp$loop$prop$page$1,"normal",d.bind(this),g,f)}.bind(b));else for(var h={},k=0;k<a.length;h={$jscomp$loop$prop$page$3:h.$jscomp$loop$prop$page$3},k++)h.$jscomp$loop$prop$page$3=a[k],"object"!=typeof e&&e.match(/none/)?b.getPrintImgType(h.$jscomp$loop$prop$page$3).then(function(l){return function(m){pageResourceLoad(l.$jscomp$loop$prop$page$3,m,d.bind(b),g,f)}}(h)):pageResourceLoad(h.$jscomp$loop$prop$page$3,"normal",d.bind(b),g,f)})}},getPrintImgType:function(a){var b,
c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return b="normal",e.yield(getPageDir(a,"thumb"),2);if(3!=e.nextAddress)return c=e.yieldResult,e.yield(getPageDir(a,"previewPage"),3);d=e.yieldResult;c.match(/none/)?d.match(/none/)||(b="previewPage"):b="thumb";return e.return(b)})},getPages:function(a){if("all"==a){a=[];for(var b=1;b<=bookConfig.totalPageCount;b++)a.push(b);return a}return"current"==a?BookInfo.getCurrentPages():getPagesByRange(a)},initPrintEvent:function(){this.button.onTap(function(a){this.printType=
this.button.printType;switch(this.printType){case "printAll":var b=this.getPages("all");this.printPages(b);break;case "printCurrent":b=this.getPages("current");this.printPages(b);break;case "printRange":a=$("#print_range_num").val();if(0>=parseInt(a))return;b=this.getPages(a);this.printPages(b)}BookEvent.trigger("print",[BookInfo.getCurrentPageIndex(),"printAll"==this.printType?"all":b.join(","),this.printType])}.bind(this))},initPrintStack:function(a){window.printLoadStack&&(window.printLoadStack.destroy(),
...
this.loadingIcon=$("<img style='position:absolute;transform : translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);left : 50%;top : 50%;z-index:1112' src='"+uiBaseURL+"loading.gif' />"),this.printLoad.append(this.loadingIcon),tmpContainer.append(this.printLoad));this.showPrintLoading()},showPrintLoading:function(){this.printLoad&&this.printLoad.fadeIn(200)},hidePrintLoading:function(){this.printLoad&&this.printLoad.fadeOut(200)}}),PrintElements=Class({create:function(a){this._super(a);this.printOnUrl=
form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";this.printOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+"print_off.png";this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("<div class='printAll item' print='printAll'><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span><img src='"+this.printOffUrl+"'/></div>"),this.printCurrent=$("<div class='printCurrent item on' print='printCurrent'><span class='title'>"+
getLanguage("frmPrintcurrent","Print Current Pages")+"</span><img src='"+this.printOnUrl+"'/></div>"),this.printRange=$("<div class='printRange item' print='printRange'><input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'></input><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><img src='"+this.printOffUrl+"'/></div>")):(this.printAll=$("<div class='printAll item' print='printAll'><img src='"+this.printOffUrl+"'/><span class='title'>"+
getLanguage("frmPrintall","Print All Pages")+"</span></div>"),this.printCurrent=$("<div class='printCurrent item on' print='printCurrent'><img src='"+this.printOnUrl+"'/><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span></div>"),this.printRange=$("<div class='printRange item' print='printRange'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample",
"Example:1,3-7,12")+"'></input></div>"));this.printButton=$("<div class='printButton title'>"+getLanguage("frmPrintbtn","Print")+"</div>");this.printButton.printType="printCurrent";this.analysis=new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},pickElements:function(a){a.printOnUrl=this.printOnUrl;a.printOffUrl=this.printOffUrl;a.printAll=this.printAll;a.printCurrent=this.printCurrent;a.printRange=this.printRange;a.printButton=this.printButton;a.pictureListForm=this.pictureListForm},
initEvent:function(a){this.printAll.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printCurrent.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printRange.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printRange.find("input").on("input propertychange change",function(){this.refreshPrintButton()}.bind(this));this.printRange.find("input").bind("mousedown touchstart pointerdown mouseover mousemove touchmove touchstend",function(b){b.stopPropagation()})},
buttonEvent:function(a,b){var c=a.stage.find(".on");c.find("img").attr("src",this.printOffUrl);c.find("img")[0].colorChanged=!1;c.removeClass("on");$(b).find("img").attr("src",this.printOnUrl);$(b).find("img")[0].colorChanged=!1;$(b).addClass("on");b=$(b).attr("print");a.printButton.printType=b;this.refreshPrintButton();a.changeItemColor()},refreshPrintButton:function(){"printRange"!=this.printButton.printType||$("#print_range_num").val()?this.lightPrintButton():this.darkPrintButton()},lightPrintButton:function(){$(this.printButton).addClass("usable");
...
form_icons.print_on:uiBaseURL+"print_on.png";this.downloadOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+"print_off.png";this.initConfig();this.initElements();this.initEvent(a);this.pickElements(a);bookConfig.isEncryptionBook&&this.setRestrictMode()},initConfig:function(){this.downloadconfig=window.downloadconfig},initElements:function(){this.rightToLeft?(this.downloadAll=$("<div class='downloadAll item' download='downloadAll'><span class='title'>"+getLanguage("DownloadFullPublication",
"Full Publication")+"</span><img src='"+this.downloadOffUrl+"'/></div>"),this.downloadCurrent=$("<div class='downloadCurrent item' download='downloadCurrent'><span class='title'>"+getLanguage("DownloadCurrentPage","Current Page")+" </span><span class='page'>"+this.pageIndex+"</span><img src='"+this.downloadOffUrl+"'/></div>"),this.downloadAttachments=$("<div class='downloadAttachments item' download='downloadAttachments'><span class='title'>"+getLanguage("DownloadAttachedFiles","Attached Files")+
"</span><img src='"+this.downloadOffUrl+"'/></div>")):(this.downloadAll=$("<div class='downloadAll item' download='downloadAll'><img src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadFullPublication","Full Publication")+"</span></div>"),this.downloadCurrent=$("<div class='downloadCurrent item' download='downloadCurrent'><img src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadCurrentPage","Current Page")+"</span><span class='page'>"+this.pageIndex+"</span></div>"),
this.downloadAttachments=$("<div class='downloadAttachments item' download='downloadAttachments'><img src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadAttachedFiles","Attached Files")+"</span></div>"));this.downloadButton=$("<div class='downloadButton title button_hover'>"+getLanguage("btnDownload","Download")+"</div>");this.restrictedTips=$("<div class='download-restricted-tips'>*"+getLanguage("downloadRestrictionTips","English"==UserGroups?"Download access for this book is restricted by the publisher.":
